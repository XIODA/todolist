...
$query = 'SELECT * FROM `test`.`todolist` where finish=1';
         ...
         
{
    ...
    <form action="./finish_2.php" method="post">
    <input type="text" value="'.$row['id'].'"name="uid"" hidden>
    <input type="submit" value="未完成" style="background-color:#685F74 ; color: white ; font-size: 17px; cursor: pointer;"></form>
